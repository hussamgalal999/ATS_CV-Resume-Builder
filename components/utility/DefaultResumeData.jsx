const DefaultResumeData = {
  ...
  contactInformation: "+(20) 011-518-580-57",
  email: "hussamgalal999@gmail.com",
  address: "Egypt, CAIRO",
  profilePicture: "",
  socialMedia: [
    {
      socialMedia: "Github",
link: "github.com/hussamgalal999",
    },
    {
      socialMedia: "LinkedIn",
link: "https://cutt.ly/BejOk56J",
    },
    {
      socialMedia: "Website",
      link: "hussamgalal999.github.io",
    },
  ],
  summary: "Resourceful Software Developer with 11 years of experience in designing and developing user interfaces, testing and training employees. Skilled at utilizing a wide variety of tools and programs to provide effective applications.",
  education: [
    {
      "school": "Bachelor of Management Information Systems(MIS)",
      "degree": "EST-MINYA",
  ...
  workExperience: [
    ...
    },
    {
      ...
      "position": "Front End Web Software Developer",
  ...
  certifications: [
    "Certified Web Professional-Web Software Developer",
